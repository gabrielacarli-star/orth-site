...
--
-- Já com os PDFs e capas no Storage e os links de checkout da Hotmart de
-- cada produto.
--
...
values
  (
    ...
    'https://pay.hotmart.com/M106684784V',
    true,
    false
  ),
  (
    ...
    'https://pay.hotmart.com/G106684861L',
    true,
    false
  ),
  (
    ...
    'https://pay.hotmart.com/L106550261O',
    true,
    false
  )
